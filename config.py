...
import numpy as np
import sys
# sys.path.append("/home/zly/neural-motifs2/data")
# sys.path.append("/home/zly/neural-motifs2")
ROOT_PATH = os.path.dirname(os.path.realpath(__file__))
ROOT_PATH= '/home/zly/neural-motifs2'
...
VG_IMAGES = '/data2/zly/vg/VG_100K'
RCNN_CHECKPOINT_FN = path('faster_rcnn_500k.h5')

IM_DATA_FN = stanford_path('/data2/zly/vg/image_data.json')
